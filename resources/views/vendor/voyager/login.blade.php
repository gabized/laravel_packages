                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            <h1>{{ Voyager::setting('admin_title', 'Laravel demo') }}</h1>
                            <p>{{ Voyager::setting('admin_description', 'Demo Laravel - Admin. (c) Gabized 2017') }}</p>
                        </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 login-sidebar animated fadeInRightBig">
            ...
            <div class="login-container animated fadeInRightBig">
                ...
                <div class="group">
                  ...
                  <span class="highlight"></span>
                  <span class="bar"></span>
                  <label><i class="glyphicon glyphicon-lock"></i><span class="span-input"> Parola</span></label>
                </div>
