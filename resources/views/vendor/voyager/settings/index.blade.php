...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-settings"></i> Setari
    </h1>
@stop
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-info">
            ...
            <p>Setarile se pot chema cu sintaxa: <code>Voyager::setting('key')</code></p>
        </div>
        @endif
    </div>
    ...
    <div class="page-content container-fluid">
        <form action="{{ route('voyager.settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary pull-right">Salveaza setarile</button>
        </form>
        ...
        <div class="panel" style="margin-top:10px;">
            <div class="panel-heading new-setting">
                <hr>
                <h3 class="panel-title"><i class="voyager-plus"></i> Setare noua</h3>
            </div>
            <div class="panel-body">
                <form action="{{ route('voyager.settings.store') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="col-md-4">
                        <label for="display_name">Titlu</label>
                    ...
                    <div class="col-md-4">
                        <label for="asdf">Tip</label>
                        <select name="type" class="form-control" required="required">
                            <option value="">Alege tipul campului</option>
                    ...
                    <button type="submit" class="btn btn-primary pull-right new-setting-btn">
                        <i class="voyager-plus"></i>Adauga setarea noua
                    </button>
                    <div style="clear:both"></div>
                </form>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <i class="voyager-trash"></i> Esti sigur ca vrei sa stergi setarea <span id="delete_setting_title"></span>?
                    </h4>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('voyager.settings.delete', ['id' => '__id']) }}" id="delete_form" method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
                        <input type="submit" class="btn btn-danger pull-right delete-confirm" value="Da, sterge setarea">
                    </form>
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">Anuleaza</button>
                </div>
            </div>
        </div>
    </div>
